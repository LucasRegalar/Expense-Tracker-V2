<div class="card card__side-navigation-card">
                <div>
                    <div class="profile-information">
                        <?php if($_SESSION["logged_in"] ?? false) : ?>
                            <img class="profile-information__profile-image" src="Images/Polish_20230128_123908160.jpg" alt="profil-picture" />
                ...
                <form method="POST" action="/session">
                    ...
                    <button id="sign-out-btn" class="button--styleless"><i class="fa-solid fa-right-from-bracket"></i>Sign Out</button>
                </form>
            </div>
