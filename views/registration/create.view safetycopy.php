        ...
        <div class="inner-card inner-card--tight">
            ...
            <div class="card--split-2-clmns">
                <form class="form" action="/register" method="POST">
                    ...
                    <input name="email" type="email" class="inner-card--outer-card-styling" placeholder="E-Mail" autocomplete="off"
                        required <?= isset($_SESSION["_flash"]["old"]["email"]) ? "value='{$_SESSION['_flash']['old']['email']}'" : '' ?> />
                    <label for="username" hidden>Username</label>
                    <input name="username" type="text" class="inner-card--outer-card-styling" placeholder="Username"
                    ...
                    <button id="register-btn" class="add-btn add-btn--green margin-inline-auto" style="margin-top: 2rem"
